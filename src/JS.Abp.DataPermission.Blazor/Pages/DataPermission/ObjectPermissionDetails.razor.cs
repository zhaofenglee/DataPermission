...
{
    public partial class ObjectPermissionDetails
    {
        [Parameter]
        ...
        public ObjectPermissionDetails()
        {
        ...
        {
            BreadcrumbItems.Add(new Volo.Abp.BlazoriseUI.BreadcrumbItem(L["Menu:ObjectPermissions"],url:"/DataPermission/ObjectPermissions"));
        ...
        {
            var objectPermission = await ObjectPermissionsAppService.GetAsync(DetailId);
        ...
        private async Task OpenEditObjectPermissionModalAsync()
        {
            var objectPermission = await ObjectPermissionsAppService.GetAsync(DetailId);
